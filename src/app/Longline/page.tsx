...
export default function MoreLongline () {
  return (
    <div className="main">
      <div className="MoreBentoMax">
        <div className="MoreBentoMax-text">
          <div className="MoreBentoMax-text__title">Бисквитные/ярусные торты</div>

          <div className="MoreBentoMax-text__picture">
            <Image className="MoreBentoMax-text__img" src={Longline} alt="Bento" />
          </div>
        </div>
      </div>
